...
export default async function DepartmentsPage() {
  ...
  return <MastersManager kind="department" hint="Organize tests by department (Hematology, Biochemistry…)." items={rows.map((r) => ({ id: r.id, name: r.name, isActive: r.isActive }))} />;
}
